<div id="item_search">
    <section class="grid grid-cols-4 auto-rows-fr gap-4 mb-8 mt-5 m-full px-4">
        ...
        <div class="rounded-xl shadow-md hover:shadow-xl bg-white flex flex-col">
            <a href=""></a>
            <!-- header -->
            <a href="{{url('mm_cars/hundai/1111')}}">
            ...
            <div class="grow flex flex-col content-between justify-between font-normal pt-3 px-3 pb-4 ">
                <div class="flex h-20 justify-between align-baseline gap-x-4  border-b-2 border-neutral-300">
                    <a href="">
                        <div class="capitalize font-sans text-gray-dark text-[14px]">2016 Jeep for Sale</div>
                        <div class="text-gray-light text-[13px]" style="color:rgb(101 , 96 , 96 , )">51.96 Miles</div>
                    </a>
                    <div>
                        <a href="" class="text-right shrink-0 ">
                            <div class="text-gray-darkest font-dispaly font-bold text-xl"> $178000</div>
        ...
        <div class="rounded-xl shadow-md hover:shadow-xl bg-white flex flex-col">
                ...
                <div class="w-full overflow-hidden  rounded-xl  " >
                    ...
                    <div id="indicators-carousel" class="relative w-full" data-carousel="static">
                        ...
                        <div class="relative h-56 overflow-hidden rounded-lg md:h-96">
                            <!-- Item 1 -->
                            <div class="hidden duration-700 ease-in-out" data-carousel-item="active">
                                <img src="{{asset('storage/img/dog-log-in.jpg')}}" class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="...">
                            </div>
                            <!-- Item 2 -->
                            <div class="hidden duration-700 ease-in-out" data-carousel-item>
                                <img src="{{asset('storage/img/zqfDT1BcYXoBV2qZdsECSvoOzYh5AdqE9tziLjfI.jpg')}}" class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="...">
            ...
            <div class="grow flex flex-col content-between justify-between font-normal pt-3 px-3 pb-4 ">
                ...
                <div class="border-t-1 flex justify-around min-h-[2.75rem]">
                    <a href="" class="text-gray-darkest text-xs font-medium pt-3 flex-grow ">
                        <div class="inline-block align-top text-lg pl-3 pr-3  border-r-2 mt-0.5 relative border-display " >
                            <i class="fa-solid fa-house i-color"></i>
                        </div>
                        <div class="inline-block align-top ml-2">
                            <div class="font-bold">Shipping Available</div>
