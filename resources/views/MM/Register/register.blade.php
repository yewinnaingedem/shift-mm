    ...
    <div class="bg-gray-100 text-gray-500 rounded-3xl shadow-xl w-full overflow-hidden" style="max-width:1000px">
        <div class="md:flex w-full">
            ...
            <div class="w-full md:w-1/2 py-10 px-5 md:px-10">
                ...
                <div>
                    <form action="{{url('mm_cars/register')}}" method="post">
                        @csrf     
                        <div class="flex -mx-3">
                            <div class="w-1/2 px-3 mb-5">
                                ...
                                <div class="flex">
                                    ...
                                    <input type="text" class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" name="name" placeholder="Enter Name">
                                    @if($errors->has('name')) 
                                        <p class="text-red-700 font-semibold ">{{$errors->first('name')}}</p>
                                    @endif 
                                </div>
                            </div>
                            <div class="w-1/2 px-3 mb-5">
                            ...
                            <div class="w-full px-3 mb-12">
                                ...
                                <div class="flex">
                                    ...
                                    @if($errors->has('password'))
                                        <p class="text-red-700 font-semibold">{{$errors->first('password')}}</p>
                                    @endif 
                                </div>
                            </div>
                        </div>
                        <div class="flex -mx-3">
                            <div class="w-full px-3 mb-5">
                                <button class="block w-full max-w-xs mx-auto bg-indigo-500 hover:bg-indigo-700 focus:bg-indigo-700 text-white rounded-lg px-3 py-3 font-semibold" type="sumbit">REGISTER NOW</button>
                            </div>
                        </div>
                    </form>
                </div>
