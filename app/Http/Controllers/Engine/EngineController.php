...
class EngineController extends Controller
{
    ...
    {
        $engines = Engine::select('engines.engine_power_id' , 'engine_powers.engine_power' , 'engines.created_at' , 'engines.id' , 'engines.Turbo' , 'cylinders.cylinder' , 'engine_types.type')
